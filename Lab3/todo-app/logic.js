function createTask(text) {
    ...
    let taskDeleteButton = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    let path = document.createElementNS('http://www.w3.org/2000/svg', 'path');
    taskDeleteButton.appendChild(path);
    taskDeleteButton.setAttribute('width', '16');
    taskDeleteButton.setAttribute('height', '16');
    taskDeleteButton.setAttribute('fill', 'currentColor');
    taskDeleteButton.setAttribute('viewBox', "0 0 16 16");
    taskDeleteButton.classList.add('bi', 'bi-trash2-fill');
